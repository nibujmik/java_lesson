...
//char 배열은 2바이트 정수를 저장하여 문자(모양)을 표현한다.
	public static void main(String[] args) {
		//char 배열의 선언
		char[] carr1= {'i','a','m',' ','j','a','v','a'};		//8개 문자형 배열을 참조하는 변수
		...
		System.out.println("carr1 배열 3번째 데이터의 값 (정수): "+ (int)carr1[2]); //109
		System.out.println("carr2 배열 3번째 데이터의 값 (정수): "+ (int)carr2[2]); //0
		...
		System.out.println("\n[[[[char 배열 테스트-3]]]]");
		System.out.println("4.문자열로 배열을 변경");
//		carr2 = "hello hi goodbye";  			//char배열에 바로 문자열 대입은 오류
		carr2 = "hello hi goobye".toCharArray(); //String 문자열 객체를 char 배열로 변환
		System.out.println(carr2);
		System.out.println(carr2[2]);
		System.out.println("carr.length : "+carr2.length);
		
		carr2="hello hi goobye hello hi goobye".toCharArray(); //문자열이 선언된 배열크기보다 크다
				System.out.println(carr2);
